...
import { GIT_HOST } from '@unconfig/meta'
...
export const gitlabSourceContentRegex = new RegExp(
  `^http://${GIT_HOST}/.*`,
  'i',
)
...
export const pwa: Partial<VitePWAOptions> = {
  ...
  workbox: {
    ...
    runtimeCaching: [
      ...
      {
        urlPattern: gitlabSourceContentRegex,
        handler: 'CacheFirst',
        options: {
          cacheName: 'gitlabcontent-images-cache',
          expiration: {
            maxEntries: 10,
            maxAgeSeconds: 60 * 60 * 24 * 365, // <== 365 days
          },
